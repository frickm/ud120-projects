...
def preprocess(words_file="word_data.pkl", authors_file="email_authors.pkl"):
    ...
    import pkgutil
    words_file = pkgutil.get_data('tools', words_file)
    authors_file = pkgutil.get_data('tools', authors_file)

    ### the words (features) and authors (labels), already largely preprocessed
    ### this preprocessing will be repeated in the text learning mini-project
    authors = pickle.loads(authors_file)
    word_data = pickle.loads(words_file)
